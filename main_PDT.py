...
if __name__ == '__main__':
    ...
    joblib.dump(scaler, 'fertility_scaler.pkl')
    joblib.dump(clf, 'fertility_model.pkl')
    ...
    result_df.to_csv('probability_Fertility.csv', index=False)